    ...
    <div class="container py-4 dash-container" style="max-width: 850px;">
        ...
        <div class="glass-card mb-4">
            <div class="p-3 bg-white text-center border-bottom">
               <img src="/assets/Upload/header.png"class="img-fluid" style="max-height: 80px;">
            </div>
            ...
            <div class="px-4 pb-4 bg-white"><img src="/assets/Upload/footer.png" class="img-fluid"></div>
        </div>
